    ...
    <>
      ...
      >
        ...
        <div className='offcanvas-menu'>
          ...
          <Link href={'#'} onClick={(e) => handleLinkClick(e, '#services')}>
            Услуги
          </Link>
          <Link href={'#'} onClick={(e) => handleLinkClick(e, '#calculate')}>
            Калькулятор
          </Link>
          <Link href={'#'} onClick={(e) => handleLinkClick(e, '#works')}>
            Наши работы
          </Link>
          <Link href={'#'} onClick={(e) => handleLinkClick(e, '#questions')}>
            Вопросы
          </Link>

...
export function OffCanvas({ isOpen, onClose }) {
    ...
    return (
        <>
            <div className={"offcanvas" + (isOpen ? " show" : "")} id="offcanvasRight">
                <div className="offcanvas-header">
                    <button className="btn-close" onClick={onClose}>
                        <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path d="M7.432 15.852V0.947999H9.052V15.852H7.432ZM0.592 9.192V7.644H15.892V9.192H0.592Z" fill="#000"/>
                        </svg>
                    </button>
                </div>
                <div className="offcanvas-menu">
                    ...
                    <Link href={"#"} onClick={(e) => handleLinkClick(e, '#services')}>Услуги</Link>
                    <Link href={"#"} onClick={(e) => handleLinkClick(e, '#calculate')}>Калькулятор</Link>
                    <Link href={"#"} onClick={(e) => handleLinkClick(e, '#works')}>Наши работы</Link>
                    <Link href={"#"} onClick={(e) => handleLinkClick(e, '#questions')}>Вопросы</Link>
                    <Link href={"#"} onClick={(e) => handleLinkClick(e, '#reviews')}>Отзывы</Link>
                    <div className="phone">

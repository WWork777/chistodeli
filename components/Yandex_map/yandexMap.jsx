...
export function YandexMap() {
  ...
  useEffect(() => {
      ...
      if (window.ymaps && mapRef.current) {
        window.ymaps.ready(() => {
          ...
          setTimeout(() => {
            ...
            const copyrights = mapRef.current.querySelectorAll(".ymaps-2-1-79-copyrights-pane, .ymaps-2-1-79-copyright");
    ...
    if (window.ymaps) {
      ...
      script.src = "https://api-maps.yandex.ru/2.1/?apikey=2a907ab4-e930-4aca-9ebb-13d8e04a56a5&lang=ru_RU";
      script.async = true;
        ...
        <div className="map-contacts">
            ...
            <div className="map-all-contacts">
                <div className="map-contact-adress">
                    <h4>Адрес:</h4>
                    <span>ул. Тульская 28, офис 5, Кемерово,<br/>Кемеровская обл. 650002</span>
                </div>

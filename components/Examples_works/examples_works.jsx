...
export function ExampleWorks() {
  ...
  const [paddingRight, setPaddingRight] = useState(144); // Default SSR value: 1200 * 0.12 = 144
  ...
  // HELPERS
  const getPaddingRight = (screenWidth, mobile) =>
    mobile ? 17 : Math.round(screenWidth * 0.12);
  const calcMetrics = () => {
    ...
    return { slideWidth, totalWidth, maxPosition };
  };
  const { maxPosition, slideWidth, totalWidth } = calcMetrics();
  ...
  useEffect(() => {
    const update = () => {
      ...
      setPaddingRight(getPaddingRight(screenWidth, mobile));
    };
    update();
  ...
  useEffect(() => {
    ...
    setPosition((prev) =>
      prev < maxPosition ? maxPosition : prev > 0 ? 0 : prev
    );
                  ...
                  >
                    ...
                    >
                      <div className='image-comparison'>
                        ...
                        <div
                          className='image-side image-right'
                          style={{ width: `${100 - split}%` }}
                        >
                          <Image
                            src={`/ExamplesWorks/${right.img}`}
                            width={ITEM_W}
                            height={ITEM_H}
                            alt='Правая работа'
                            className='comparison-image'
